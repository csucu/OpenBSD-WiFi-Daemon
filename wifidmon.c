...
/**
 * Checks if a network is active or not
...
/**
 * Configures device for a non encrypted network
...
/**
 * Configures device for a WPA encrypted network
 * @param char name - name of device
 * 	      char nwidName - network id
...
/**
 * This method is used to resolve a applicable configuration
...
/**
 * Parses are last used configuration file
...
/**
 * Opens a socket, for are iotcl ops
 *
 * */
...
/**
 * Compares two network id's chars
...
/**
 * Staticly assigns an IP address and default route
 *
 **/
int staticAssign(void)
{
...
/**
 * Gets are ip address and netmask
 **/
